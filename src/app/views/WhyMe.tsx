  ...
  return (
    <section id='why-me' className='bg-primary py-10'>
      <div className="container">
        ...
        <div className="content-wrapper -mx-6 pt-8 text-justify">
          <div className="flex flex-wrap mb-12">
            <div className="md:w-1/2 px-6 pt-2">
              <div className="img-holder relative h-80">
                <Image sizes='100vw' src="/img02.jpg" alt='image of laptop' className='object-cover' fill />
              </div>
            </div>
            <div className="md:w-1/2 px-6 text-xl">
              <h3 className='text-2xl mb-4 capitalize'>Extensive Fullstack Expertise</h3>
          ...
          <div className="flex flex-wrap mb-12">
            <div className="md:w-1/2 px-6 md:order-2">
              <div className="img-holder relative h-80">
                <Image sizes='100vw' src="/img04.jpeg" alt='image of laptop' className='object-cover' fill />
              </div>
            </div>
            <div className="md:w-1/2 px-6 text-xl md:order-1">
              <h3 className='text-2xl mb-4 capitalize'>Versatility and Adaptability</h3>
          ...
          <div className="flex flex-wrap mb-12">
            <div className="md:w-1/2 px-6 pt-2">
              <div className="img-holder relative h-80">
                <Image sizes='100vw' src="/img05.jpg" alt='image of laptop' className='object-cover' fill />
              </div>
            </div>
            <div className="md:w-1/2 px-6 text-xl">
              <h3 className='text-2xl mb-4 capitalize'>End-to-End Project Ownership</h3>
          ...
          <div className="flex flex-wrap mb-12">
            <div className="md:w-1/2 px-6 md:order-2">
              <div className="img-holder relative h-80">
                <Image sizes='100vw' src="/img03.png" alt='image of laptop' className='object-cover' fill />
              </div>
            </div>
            <div className="md:w-1/2 px-6 text-xl md:order-1">
              <h3 className='text-2xl mb-4 capitalize'>Problem-Solving Mindset</h3>
          ...
          < div className="md:w-1/2 px-6 pt-2">
              <div className="img-holder relative h-80">
                <Image sizes='100vw' src="/img06.jpg" alt='image of laptop' className='object-cover' fill />
              </div>
            </div>
            <div className="md:w-1/2 px-6 text-xl">
              <h3 className='text-2xl mb-4 capitalize'>Continuous Learning</h3>
